...
COPY ./perl_modules.bash $INSTALL_PATH_REMOTE/.
...
COPY ./${INSTALL_PATH_HOST}/Moose-2.2014.tar.gz ${INSTALL_PATH_REMOTE}/.
RUN bash $INSTALL_PATH_REMOTE/perl_modules.bash $INSTALL_PATH_REMOTE
